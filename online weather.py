...
def multiple_attributes(Attribute1, Attribute2):
    ...
    if Attribute2 == "Temperature":
        df1 = pd.read_csv("Temperature day.csv", sep=";")
    elif Attribute2 == "Downfall":
        df1 = pd.read_csv("Downfall day.csv", sep=";")  
    df = df.set_index("Datum")
...
while menus != "":
    ...
    if menus == "A":
        Attribute = input("Choose an attribute you want to view [Temperature, Downfall]: ")
        ...
        Attribute = input("Choose an attribute you want to view in hours [Temperature, Downfall, Sunshine]: ")
        hours = int(input("Select over how many hours you want to view: "))
        interval_hour(Attribute, hours)
        menus = menu()
    elif menus == "D":
        Attribute1 = input("Choose the base attribute you want to compare against [Temperature, Downfall]: ")
        Attribute2 = input("Choose the second attribute you want to compare with [Temperature, Downfall]: ")
        print(multiple_attributes(Attribute1, Attribute2))
        menus = menu()
    elif menus == "E":
        perc_sunshine()
        menus = menu()
